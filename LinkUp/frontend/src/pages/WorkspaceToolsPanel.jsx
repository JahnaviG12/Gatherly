...
const WorkspaceToolsPanel = ({
  workspace, currentUser, activeTool, setActiveTool, onClose, socket, navigate,
  chatMessage, setChatMessage, activeChannel, setActiveChannel,
  unreadChannels, setUnreadChannels, getFilteredMessages,
  handleSendChatMessage, handleFileUpload, handleVoiceNote,
  isRecording, showEmojis, setShowEmojis, fileInputRef,
  workspaceTasks, workspaceExpenses,
  handleVotePoll, handleCreatePoll,
  aiInput, setAiInput, handleSendAiMessage,
  extractedAiMessages, handleExtractTasks,
  updateWorkspaceData, getSpaceId, setSelectedWorkspace, autoJoinCall, setAutoJoinCall,
}) => {
